...
def main():
    ...
    data_path = os.path.join(cfg.output_dir, "expanded_preference_pairs_train_0_99.json")
    ...
    save_json(os.path.join(cfg.output_dir, "action_preference_train_history.json"), history)

    print(f"[INFO] saved preference model -> {model_path}")
