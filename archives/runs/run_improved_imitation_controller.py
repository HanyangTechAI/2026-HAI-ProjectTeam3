...
def main():
    ...
    save_json(os.path.join(cfg.output_dir, "improved_imitation_controller_records.json"), records)
    save_json(os.path.join(cfg.output_dir, "improved_imitation_controller_summary.json"), summary)
