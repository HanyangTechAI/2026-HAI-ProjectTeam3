...
def main():
    ...
    save_json(os.path.join(cfg.output_dir, "improved_imitation_controller_records_v2.json"), records)
    save_json(os.path.join(cfg.output_dir, "improved_imitation_controller_summary_v2.json"), summary)
