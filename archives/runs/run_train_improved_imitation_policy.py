...
def main():
    ...
    data_path = os.path.join(cfg.output_dir, "policy_improvement_dataset.json")
    ...
    model_path = os.path.join(cfg.output_dir, "improved_imitation_policy_embedding.pt")
    torch.save(
        {
    ...
    save_json(os.path.join(cfg.output_dir, "improved_imitation_train_history.json"), history)

    print(f"[INFO] saved improved imitation model -> {model_path}")
