...
def main():
    ...
    data_path = os.path.join(cfg.output_dir, "policy_improvement_dataset_explore.json")
    ...
    model_path = os.path.join(cfg.output_dir, "improved_imitation_policy_embedding_v2.pt")
    torch.save(
        {
    ...
    save_json(
        os.path.join(cfg.output_dir, "improved_imitation_train_history_v2.json"),
        history,
    )

    print(f"[INFO] saved improved imitation v2 model -> {model_path}")
